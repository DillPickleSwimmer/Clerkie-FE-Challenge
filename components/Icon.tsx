...
function getIconSvg(iconType: IconTypes): JSX.Element {
    switch(iconType) {
        case IconTypes.filter: 
            return <>
                <path d="M6 3.5H18" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                <circle cx="3" cy="3.5" r="2.25" strokeWidth="1.5"/>
                <path d="M13 10.5H0.999999" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                <circle cx="3" cy="3" r="2.25" transform="matrix(-1 0 0 1 19 7.5)" strokeWidth="1.5"/>
                <path d="M6 17.5H18" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                <circle cx="3" cy="17.5" r="2.25" strokeWidth="1.5"/>
            </>; 
        case IconTypes.friends: 
            return <>
                <circle cx="16.7171" cy="9.82941" r="1.61164" strokeWidth="0.75"/>
                <path d="M19.7632 15.328C19.7632 13.5725 18.3401 12.1494 16.5846 12.1494C15.8692 12.1494 15.2089 12.3858 14.6777 12.7847" strokeWidth="0.85" strokeLinecap="round"/>
                <circle cx="10.3575" cy="8.92143" r="3.13139"/>
                <path d="M15.8048 17.9998C15.8048 14.9915 13.3661 12.5527 10.3577 12.5527C7.34939 12.5527 4.91064 14.9915 4.91064 17.9998" strokeLinecap="round"/>
            </>;
        case IconTypes.home: 
            return <>
                <rect x="4.43984" y="4.43984" width="15.12" height="15.12" rx="1.32" stroke="#EAEAEA" strokeWidth="1.2"/>
        ...
        case IconTypes.close:
            return <>
                <path d="M4 4L13 13" strokeWidth="2" strokeLinecap="round"/>
                <path d="M13 4L4 13" strokeWidth="2" strokeLinecap="round"/>
            </>;
        default: 
            return null;
    }
...
export default function Icon({color = "currentColor", size, iconType}: {color?: string, size: number, iconType: IconTypes}) {
    return (
        <svg width={size} height={size} viewBox={`0 0 ${size} ${size}`} fill="none" stroke={color} xmlns="http://www.w3.org/2000/svg">
            {getIconSvg(iconType)}
        </svg>
    );
}