...
function getIconSvg(iconType: IconTypes): JSX.Element {
    switch(iconType) {
        case IconTypes.filter: 
            return <>
                <path d="M6 3.5H18" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                <circle cx="3" cy="3.5" r="2.25" stroke-width="1.5"/>
                <path d="M13 10.5H0.999999" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                <circle cx="3" cy="3" r="2.25" transform="matrix(-1 0 0 1 19 7.5)" stroke-width="1.5"/>
                <path d="M6 17.5H18" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                <circle cx="3" cy="17.5" r="2.25" stroke-width="1.5"/>
            </>; 
        case IconTypes.friends: 
            return <>
                <circle cx="16.7171" cy="9.82941" r="1.61164" stroke-width="0.75"/>
                <path d="M19.7632 15.328C19.7632 13.5725 18.3401 12.1494 16.5846 12.1494C15.8692 12.1494 15.2089 12.3858 14.6777 12.7847" stroke-width="0.85" stroke-linecap="round"/>
                <circle cx="10.3575" cy="8.92143" r="3.13139"/>
                <path d="M15.8048 17.9998C15.8048 14.9915 13.3661 12.5527 10.3577 12.5527C7.34939 12.5527 4.91064 14.9915 4.91064 17.9998" stroke-linecap="round"/>
            </>;
        case IconTypes.home: 
            return <>
                <rect x="4.43984" y="4.43984" width="15.12" height="15.12" rx="1.32" stroke="#EAEAEA" stroke-width="1.2"/>
